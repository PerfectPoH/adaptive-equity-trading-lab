...
The hybrid free-provider architecture is preserved as a research path, but not accepted as a backtest data source yet. Hybrid Free Data Mesh requires component-level micro-probe validation before any ingestion or Candidate 012 run.
