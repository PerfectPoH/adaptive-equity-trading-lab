...
- [x] Redigere preregistrazione `TRIAL-NCTRL-001` come property-based negative control; stato `PRE-REGISTERED / NOT RUN / NOT IMPLEMENTATION-COMPLETE`.
- [ ] Implementare con TDD infrastruttura richiesta prima di esecuzione `TRIAL-NCTRL-001`: P5 bootstrap random baseline, P6 random-entry simulator, P4 cash-ledger fixtures, property-check report writer e accounting wiring.
