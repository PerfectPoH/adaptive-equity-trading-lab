...
- Track ranking/uscite: `TRIAL-RANKEX-001` validation fallita per sign flip ex-top3; ranking semplice chiuso/non promosso. Prima di qualunque nuovo trial small-cap serve gate Data Quality + Methodology: yfinance audit, universe as-of, random bootstrap, multiple-testing ledger, backtester audit.
