...
- Track ranking/uscite: `TRIAL-RANKEX-001` validation fallita per sign flip ex-top3; ranking semplice chiuso/non promosso. Data Quality Audit verdict: `NOT_USABLE_FOR_SMALL_CAP_TRIALS_WITH_YFINANCE_DAILY_ALONE`; Lessons Learned riclassifica il lavoro small-cap 2026-05-09..2026-05-14 come stress test metodologico/infrastrutturale, non evidenza di edge. Prossimo lavoro ammesso: scaffolding check negative-control su universo fixed large-cap/ETF, senza tuning strategico.
