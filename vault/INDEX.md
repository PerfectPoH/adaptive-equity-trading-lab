...
- Track ranking/uscite aperto: `TRIAL-RANKEX-001` ha policy, payload e comando validation preparati, ma non e' stato eseguito; prossimo passo solo se autorizzato e' validation run, non sweep.
