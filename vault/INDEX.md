...
- Track ranking/uscite: `TRIAL-RANKEX-001` validation fallita per sign flip ex-top3; ranking semplice chiuso/non promosso. Prossimo lavoro ammesso solo nuova specifica pre-registrata, preferibilmente cross-sectional momentum vs IWM, senza run.
