...
- Research validation: calibrated walk-forward folds, model comparison, feature-set comparison, target/exit comparison, signal-quality/ranking comparison, market-exposure comparison, universe-selection comparison, benchmark-objective comparison, model registry, optional risk-first modes.
