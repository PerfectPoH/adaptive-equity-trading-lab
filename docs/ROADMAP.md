...
- Research validation: calibrated walk-forward folds, model comparison, feature-set comparison, target/exit comparison, model registry, optional risk-first modes.
